...
--- default settings for file C:\Users\Chris\Desktop\NIGAL tracking\2017 Nightingale tracking\Data retrieved in 2017\S410_21Jul17_081014.lux

map_lat = 12.0393201866 = mapping start lat (if no locations generated, else uses mean)
map_lon = -0.175781 = mapping start lon (if no locations generated, else uses mean)
map_zoom = 2 = mapping default zoom (0-19, 0 being widest)

def_view_size = 24 = width of main plot (in hours)
def_view_pos = 1430072244 = start position (offset, in seconds)
def_summ = 242 = width of summary plot (in hours, or max which specifies entire log)

def_threshold = 2 = threshold

def_linear_elev = False = linearly changing elevation angle
def_min_elev = -6.0 = start/only elevation angle
