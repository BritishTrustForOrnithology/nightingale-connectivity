...
--- default settings for file C:\Users\Chris\Desktop\NIGAL tracking\Gambia retrievals Nov 2019 data\BR064_06Dec19_120014driftadj.lux

map_lat = 28.3691484916 = mapping start lat (if no locations generated, else uses mean)
map_lon = -8.03903608027 = mapping start lon (if no locations generated, else uses mean)
map_zoom = 2 = mapping default zoom (0-19, 0 being widest)

def_view_size = 24 = width of main plot (in hours)
def_view_pos = 1546261911 = start position (offset, in seconds)
def_summ = 339 = width of summary plot (in hours, or max which specifies entire log)

def_threshold = 2 = threshold

def_linear_elev = False = linearly changing elevation angle
def_min_elev = -3.5 = start/only elevation angle
